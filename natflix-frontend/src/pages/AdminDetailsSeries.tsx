...
export default function AdminDetailSeries() {
  ...
  function onCreate() {
    setModal(<FormCreate fields={Fields} endPoint={""} />);
  }

  function onUpdate(item: iDetailsSeries) {
    setModal(<FormUpdate endPoint={""} fields={Fields} data={item} />);
  }

  function onDelete(id: number) {
    setModal(<FormDelete endPoint={"/admin-content/delete-episode/"} id={id} />);
  }
